...
from master_thesis.experiments.ex1.models import (
    ObservationsGeneratorParamsSchema,
    ObservationsGeneratorOutputSchema,
    DatasetGeneratorParamsSchema,
    DatasetItemShema
)
from master_thesis.experiments.ex1.laws import (
    h1,
    h0
)
from master_thesis.experiments.ex1.fitting import (
    fit_h0,
    fit_h1
)
from master_thesis.experiments.ex1.evidence import (
    sse,
    bic
)
...
def gen_observations(
    schema: ObservationsGeneratorParamsSchema
) -> ObservationsGeneratorOutputSchema:
    ...
    return ObservationsGeneratorOutputSchema(
        xs=xs,
...
def gen_dataset(
    schema: DatasetGeneratorParamsSchema
